...
public abstract class BaseGroup {
    ...
    public SceneSuite getSuiteByIndex(int index) {
        if(suites==null){
            Grasscutter.getLogger().warn("trying to load suite from null suites in group {}", id);
            return null;
        }
    ...
    public abstract String getScriptPath(int id);
    ...
    public synchronized BaseGroup load(int parentId) {
        ...
        try {
            ...
            try {
                ...
                Grasscutter.getLogger().warn("failed to load npc for group {}", id, ex);
            }
            ...
            Grasscutter.getLogger().error("An error occurred while loading group " + this.id + " in scene " + parentId + ".", e);
        }

        Grasscutter.getLogger().debug("Successfully loaded group {} in scene {}.", this.id, parentId);
        return this;
    }
